...
<body>
    ...
    <script>
        ...
        function addToCart(id_producto, descripcion, precio) {
            var userId = "<?php echo isset($_SESSION['id_cliente']) ? $_SESSION['id_cliente'] : ''; ?>";

            if (!userId) {
                alert('Debes iniciar sesión o crear una cuenta para agregar productos al carrito.');
                return;
            }
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    cartItems.forEach(function(item) {
                        cartList.append('<li class="list-group-item">' + item.descripcion + ' - s/.' + item.precio + '.00 (Cantidad: ' + item.cantidad + ')</li>');
