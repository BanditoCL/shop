...
if (isset($_REQUEST['guardar'])) {
    ...
    $query = "INSERT INTO productos (marca, precio, stock, categoria, subcategoria, fecha_ingreso, descripcion, detalles, material, origen, peso) 
              VALUES ('$marca', '$precio', '$stock', '$categoria', '$subcategoria', '$fecha_ingreso', '$descripcion', '$detalles', '$material', '$origen', '$peso')";
                            ...
                            <form action="panel.php?modulo=crearProducto" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="categoria" id="categoria" class="form-control" required>
                                        <option value="maquinarias">Otros</option>
